...
#
# Stack names: infra, authelia, media, immich, home, backup, gaming, dev, tools, movienight, movienight-test, geopulse
...
ALL_STACKS=(infra authelia media immich home backup gaming dev tools movienight movienight-test geopulse)

...
#
# Stack names: infra, authelia, media, immich, home, backup, gaming, dev, tools, movienight, movienight-test, strava-hevy, hermes
...
ALL_STACKS=(infra authelia media immich home backup gaming dev tools movienight movienight-test strava-hevy hermes)
